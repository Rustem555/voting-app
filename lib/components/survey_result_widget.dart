                  ...
                  children: [
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          '\"За\" - ${functions.percentageYes(widget.answers?.toList())?.toString()}%',
                          textAlign: TextAlign.center,
                          style:
                    ...
                    Align(
                      ...
                      child: Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(5.0, 10.0, 5.0, 0.0),
                        child: Text(
                          '\"Против\" - ${(100 - (functions.percentageYes(widget.answers?.toList())!)).toString()}%',
                          textAlign: TextAlign.center,
                          style:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                                    font: GoogleFonts.readexPro(
                        ...
                        Align(
                          ...
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                5.0, 10.0, 5.0, 0.0),
                            child: Text(
                              widget.var1!.maybeHandleOverflow(
                                maxChars: 7,
                                replacement: '…',
                              ),
                              textAlign: TextAlign.center,
                        ...
                        Align(
                          ...
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                5.0, 10.0, 5.0, 0.0),
                            child: Text(
                              ' - ${functions.percentageYes(widget.answers?.toList())?.toString()}%',
                              textAlign: TextAlign.center,
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                        ...
                        Align(
                          ...
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                5.0, 10.0, 5.0, 0.0),
                            child: Text(
                              widget.var2!.maybeHandleOverflow(
                                maxChars: 8,
                                replacement: '…',
                              ),
                              textAlign: TextAlign.center,
                        ...
                        Align(
                          ...
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                5.0, 10.0, 5.0, 0.0),
                            child: Text(
                              ' - ${(100 - (functions.percentageYes(widget.answers?.toList())!)).toString()}%',
                              textAlign: TextAlign.center,
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
