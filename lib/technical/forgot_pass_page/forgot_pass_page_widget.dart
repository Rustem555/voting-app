          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Spacer(),
                Autocomplete<String>(
                  initialValue: TextEditingValue(text: widget.email!),
                    ...
                    onTap: () async {
                      await showDialog(
                        ...
                        builder: (alertDialogContext) {
                          return AlertDialog(
                            title: Text(
                                'Если вы указали зарегистрированный э/адрес, на него придет временный пароль (проверьте спам!)'),
                            content:
                                Text('войдите по нему, затем поменяйте его'),
                            actions: [
                              TextButton(
                                onPressed: () =>
                      ...
                      _model.resetPass = await actions.resetPassword(
