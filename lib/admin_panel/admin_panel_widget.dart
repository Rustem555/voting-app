...
import '/components/time_of_life_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<UsersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRow> adminPanelUsersRowList = snapshot.data!;
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              ...
                              FutureBuilder<List<AnketaSapRow>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<AnketaSapRow> containerAnketaSapRowList =
                                      snapshot.data!;
                              ...
                              FFButtonWidget(
                                ...
                                text:
                                    'Время жизни ${containerGlobalRow?.hoursOfLife?.toString()}ч. после посл. голосования',
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  context.pushNamed(
                                      ForbiddenQuestionsWidget.routeName);
                                },
                                text: 'Forbidden questions',
                                options: FFButtonOptions(
                                  height: 40.0,
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      16.0, 0.0, 16.0, 0.0),
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 16.0, 0.0, 55.0),
                                child: StreamBuilder<List<AnketaSapRow>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    if (listViewAnketaSapRowList.isEmpty) {
                                      return Center(
                                        child: Container(
                                          width:
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemCount:
                                          listViewAnketaSapRowList.length,
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      0.0),
                                                          child: Text(
                                                            'Проголосовало: ${listViewAnketaSapRow.answers.length.toString()} чел.',
                                                            maxLines: 3,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodyMedium
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      3.0),
                                                          child: Text(
                                                            'Время \"простоя\" ${functions.vremjaProstoya(listViewAnketaSapRow.timeOfLastVote)}',
                                                            maxLines: 3,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodyMedium
